---
name: release
description: Execute the release workflow for Biofoundry_CLI packages.
type: flow
---
...
post_merge: |md
  ...
  a single numeric tag releases the root Python package and kagent together.
|
