...
from biofoundry_llm.chat_provider.openai_common import (
...
from biofoundry_llm.contrib.chat_provider.common import ToolMessageConversion
from biofoundry_llm.message import ContentPart, Message, TextPart, ThinkPart, ToolCall, ToolCallPart
from biofoundry_llm.tooling import Tool
...
class OpenAILegacy:
    ...
    def _convert_message(self, message: Message) -> ChatCompletionMessageParam:
        """Convert a Biofoundry LLM message to OpenAI message."""
