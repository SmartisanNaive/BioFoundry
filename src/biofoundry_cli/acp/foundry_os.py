...
class ACPProcess:
    """Foundry OS process adapter for ACP terminal execution."""
...
class ACPFoundryOS:
    """Foundry OS backend that routes supported operations through ACP."""
    ...
    def __init__(
        ...
        *,
        ...
        self._fallback = fallback or local_foundry_os
    ...
    def _abs_path(self, path: StrOrFoundryPath) -> str:
        kaos_path = path if isinstance(path, FoundryPath) else FoundryPath(path)
