...
from biofoundry_cli.metadata import WorkDirMeta, load_metadata, save_metadata
from biofoundry_cli.session_state import SessionState, load_session_state, save_session_state
from biofoundry_cli.utils.logging import logger
from biofoundry_cli.wire.file import WireFile
from biofoundry_cli.wire.types import TurnBegin
...
class Session:
    ...
    @staticmethod
    async def find(work_dir: FoundryPath, session_id: str) -> Session | None:
    ...
    @staticmethod
    async def list(work_dir: FoundryPath) -> builtins.list[Session]:
    ...
    @staticmethod
    async def continue_(work_dir: FoundryPath) -> Session | None:
