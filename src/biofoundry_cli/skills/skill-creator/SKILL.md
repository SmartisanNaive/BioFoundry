...
Biofoundry_CLI loads skills in layers (built-in -> user -> project). Within each layer, it uses the
first existing directory in priority order. Built-in skills only load for LocalFoundryOS or ACPFoundryOS.
