...
from biofoundry_llm.chat_provider import TokenUsage
from biofoundry_llm.message import Message
from biofoundry_llm.tooling.empty import EmptyToolset
...
from biofoundry_cli.wire.types import ContentPart, TextPart, ThinkPart
...
class SimpleCompaction:
    ...
    async def compact(
        ...
        # Call biofoundry_llm.step to get the compacted context
        # TODO: set max completion tokens
        logger.debug("Compacting context...")
        result = await biofoundry_llm.step(
