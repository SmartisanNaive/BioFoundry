...
from biofoundry_cli.utils.path import is_within_workspace, list_directory
...
class Glob(CallableTool2[Params]):
    ...
    async def _validate_directory(self, directory: FoundryPath) -> ToolError | None:
    ...
    async def __call__(self, params: Params) -> ToolReturnValue:
        try:
            ...
            dir_path = FoundryPath(params.directory) if params.directory else self._work_dir
