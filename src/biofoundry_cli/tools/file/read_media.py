...
from biofoundry_cli.tools.file.utils import MEDIA_SNIFF_BYTES, FileType, detect_file_type
from biofoundry_cli.tools.utils import load_desc
from biofoundry_cli.utils.media_tags import wrap_media_part
from biofoundry_cli.utils.path import is_within_workspace
from biofoundry_cli.wire.types import ImageURLPart, VideoURLPart
...
class ReadMediaFile(CallableTool2[Params]):
    ...
    def __init__(self, runtime: Runtime) -> None:
        ...
        self._work_dir = runtime.builtin_args.BIOFOUNDRY_WORK_DIR
        self._additional_dirs = runtime.additional_dirs
        self._capabilities = capabilities

    async def _validate_path(self, path: FoundryPath) -> ToolError | None:
    ...
    async def _read_media(self, path: FoundryPath, file_type: FileType) -> ToolReturnValue:
    ...
    async def __call__(self, params: Params) -> ToolReturnValue:
        ...
        try:
            p = FoundryPath(params.path).expanduser()
