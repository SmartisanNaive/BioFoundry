...
from biofoundry_llm.tooling import BriefDisplayBlock, CallableTool2, ToolError, ToolReturnValue
from pydantic import BaseModel

from biofoundry_cli.soul import get_wire_or_none, wire_send
...
class ExitPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        """Late-bind soul callbacks after BiofoundrySoul is constructed."""
