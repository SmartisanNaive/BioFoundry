...
from biofoundry_os import AsyncReadable
from pydantic import BaseModel, Field

from biofoundry_cli.soul.approval import Approval
from biofoundry_cli.tools.display import ShellDisplayBlock
from biofoundry_cli.tools.utils import ToolRejectedError, ToolResultBuilder, load_desc
...
class Shell(CallableTool2[Params]):
    ...
    async def _run_shell_command(
        ...
        process = await biofoundry_os.exec(*self._shell_args(command), env=get_clean_env())
