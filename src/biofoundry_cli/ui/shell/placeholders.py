...
from biofoundry_cli.utils.string import random_string
from biofoundry_cli.wire.types import ContentPart, ImageURLPart, TextPart

_DEFAULT_PROMPT_CACHE_ROOT = get_share_dir() / "prompt-cache"
_LEGACY_PROMPT_CACHE_ROOT = Path("/tmp/biofoundry")
