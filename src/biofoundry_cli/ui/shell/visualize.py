...
from biofoundry_llm.tooling import ToolError, ToolOk
...
from biofoundry_cli.soul import format_context_status
from biofoundry_cli.tools import extract_key_argument
from biofoundry_cli.ui.shell.console import NEUTRAL_MARKDOWN_THEME, console
from biofoundry_cli.ui.shell.echo import render_user_echo, render_user_echo_text
from biofoundry_cli.ui.shell.keyboard import KeyboardListener, KeyEvent
from biofoundry_cli.ui.shell.prompt import (
    CustomPromptSession,
)
from biofoundry_cli.utils.aioqueue import QueueShutDown
from biofoundry_cli.utils.diff import format_unified_diff
from biofoundry_cli.utils.logging import logger
from biofoundry_cli.utils.rich.columns import BulletColumns
from biofoundry_cli.utils.rich.markdown import Markdown
from biofoundry_cli.utils.rich.syntax import BiofoundrySyntax
from biofoundry_cli.wire import WireUISide
...
class _ApprovalRequestPanel:
    def __init__(self, request: ApprovalRequest):
        ...
        self.options: list[tuple[str, ApprovalResponse.Kind]] = [
            ...
            ("Reject, tell the agent what to do instead", "reject"),
        ]
    ...
    def _render_block(
        ...
        if block.lexer:
            return BiofoundrySyntax(text, block.lexer)
