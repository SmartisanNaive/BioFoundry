...
from biofoundry_cli.wire.types import AudioURLPart, ImageURLPart, TextPart, VideoURLPart


def message_stringify(message: Message) -> str:
    """Get a string representation of a message."""
    # TODO: this should be merged into `biofoundry_llm.message.Message.extract_text`
    parts: list[str] = []
