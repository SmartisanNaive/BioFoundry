...
from biofoundry_cli.utils.rich.syntax import BIOFOUNDRY_ANSI_THEME_NAME, resolve_code_theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = BIOFOUNDRY_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "biofoundry-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = BIOFOUNDRY_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=BIOFOUNDRY_ANSI_THEME_NAME,
        help='code theme (pygments name or "biofoundry-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
