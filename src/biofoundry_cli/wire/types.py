...
from biofoundry_cli.tools.display import (
    DiffDisplayBlock,
    ShellDisplayBlock,
    TodoDisplayBlock,
    TodoDisplayItem,
)
from biofoundry_cli.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `biofoundry_cli.soul.approval.Request`, but
